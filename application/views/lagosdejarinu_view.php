...
<div class="container-fluid padding-off lagosdejarinu">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                <div class="col-xs-12 col-sm-12 col-md-12 padding-off">
                    <h6>Lagos de Jarinu</h6>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 padding-off box-img">
                    <span><a href="<?= base_url(); ?>assets/images/lagos/lagos-01.jpg" data-lightbox="galeria-lagos">ver todas as fotos</a></span>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 padding-off">
                    <div class="media">
                        <div class="media-left media-middle lagos">
                            <img class="media-object" alt="Logo Lagos de Jarinu" src="<?= base_url(); ?>assets/images/logo-lagos-jarinu-2.jpg" data-holder-rendered="true">
                        </div>
