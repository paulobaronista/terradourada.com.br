...
<div class="container-fluid padding-off terrasdesantacruz">
    <div class="container">
        <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 padding-off">
                    <div class="media">
                        <div class="media-left media-middle terras">
                            <img class="media-object" alt="Logo Terras de Santa Cruz" src="<?= base_url(); ?>assets/images/logo-terras-de-santa-cruz-2.jpg" data-holder-rendered="true">
                        </div>
