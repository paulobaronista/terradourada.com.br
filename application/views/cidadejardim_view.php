        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>#home"><img class="img-responsive" src="<?= base_url(); ?>assets/images/logo.png" alt="Terra Dourada Incorporações"></a>
                </div>
...
<div class="container-fluid padding-off cidadejardim">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 padding-off box-img">
                    <span><a href="<?= base_url(); ?>assets/images/cidade/cidadejardim-01.jpg" data-lightbox="galeria-cidadejardim">ver todas as fotos</a></span>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 padding-off">
                    <div class="media">
                        <div class="media-left media-middle cidade">
                            <img class="media-object" alt="Logo Cidade Jardim" src="<?= base_url(); ?>assets/images/logo-cidade-jardim-2.jpg" data-holder-rendered="true">
                        </div>
                        <div class="media-body">
                            <p>
                                SORRISO - MT<br>
                                CONDOMINIO FECHADO<br>
                                455.000 M² DE ÁREA TOTAL<br>
                                TERRENOS DE 500 A 1200 M²<br>
