...
<head>
    ...
    <meta name="title" content="Terra Dourada Incorporações" />
    <meta name="og:title" content="Terra Dourada Incorporações" />
    <meta name="og:description" content="Construindo sonhos. Entregando conquistas." />
    ...
    <meta name="theme-color" content="#391f1b" />
    <!-- property (faz funcionar no linkedin) -->
    <meta property="og:title" content="Terra Dourada Incorporações" />
    <meta property="og:image" content="<?= base_url(); ?>assets/images/compartilhamento.png" />
    <meta property="Construindo sonhos. Entregando conquistas." />
    <meta property="og:url" content="https://www.terradourada.com.br" />
    <!-- property (faz funcionar no linkedin) -->
    <?php
    $meta = array(
